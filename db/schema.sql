...
CREATE TABLE IF NOT EXISTS users (
    ...
    pin_hash TEXT,                        -- bcrypt hash cua ma PIN 6 chu so
    public_key_pem TEXT NOT NULL,         -- public key cua user, dung de verify chu ky giao dich
    private_key_pem TEXT,                 -- private key cua user de ky so giao dich (demo backend)
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    description TEXT,                     -- noi dung chuyen tien
    nonce TEXT NOT NULL,
